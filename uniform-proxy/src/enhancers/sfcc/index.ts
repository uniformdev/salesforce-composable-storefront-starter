...
export const sfccConfigured: boolean = ![
  process.env.SALESFORCE_COMMERCE_CLOUD_CLIENT_ID,
  process.env.SALESFORCE_COMMERCE_CLOUD_CLIENT_SECRET,
  process.env.SALESFORCE_COMMERCE_CLOUD_ORG_ID,
  process.env.SALESFORCE_COMMERCE_CLOUD_SHORT_CODE,
  process.env.SALESFORCE_COMMERCE_CLOUD_SITE_ID,
].includes(undefined);
