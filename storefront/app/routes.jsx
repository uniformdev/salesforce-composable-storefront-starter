...
// Pages
const UniformHome = loadable(() => import('./pages/home/uniform'), {fallback})
...
const UniformProductDetail = loadable(() => import('./pages/product-detail/uniform'), {fallback})
const ProductList = loadable(() => import('./pages/product-list'), {fallback})
const UniformProductList = loadable(() => import('./pages/product-list/uniform'), {fallback})
...
const routes = [
    ...
    },
    {
        ...
        component: UniformProductDetail
    },
    {
        path: '/search',
