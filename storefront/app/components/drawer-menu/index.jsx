...
import UniformNestedAccordion from '../uniform/nested-accordion'
 ...
 */
const DrawerMenu = ({isOpen, onClose = noop, onLogoClick = noop, root, navComposition}) => {
    const intl = useIntl()
